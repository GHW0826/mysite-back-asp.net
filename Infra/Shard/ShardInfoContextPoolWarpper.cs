...
{
    private readonly DbContextPoolService<ShardInfoContext> _dbContextPoolMultiplexerService;

    public ShardInfoContextPoolWarpper(DbContextPoolService<ShardInfoContext> dbContextPoolMultiplexerService) 
    {
