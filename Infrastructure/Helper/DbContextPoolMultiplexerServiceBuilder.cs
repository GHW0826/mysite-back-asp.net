...
public class DbContextPoolMultiplexerServiceBuilder<T> where T : DbContext
{
    ...
    public DbContextPoolMultiplexerServiceBuilder<T> AddConnectionDetails(
        string contextName,
    ...
    {
        var dbContextPoolMultiplexerService = new DbContextPoolMultiplexerService<T>(_serviceCollection, _connectionDetails);
