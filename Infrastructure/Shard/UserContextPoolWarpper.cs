...
{
    private readonly DbContextPoolMultiplexerService<UserContext> _dbContextPoolMultiplexerService;

    public UserContextPoolWarpper(DbContextPoolMultiplexerService<UserContext> dbContextPoolMultiplexerService)
    {
